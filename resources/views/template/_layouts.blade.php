...
<body>
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="index.html"><img
                        src="{{ asset('assets2/images/logo.svg') }}" class="mr-2" alt="logo" /></a>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false"
                            ...
                            <span class="menu-title">Kelola Dokumen</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.semuaDokumen') }}">Data
                                        Dokumen</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                @can('read-role')
                                <li class="nav-item"> <a class="nav-link" href="{{ route('roleView') }}"> Akses Role </a></li>
                                @endcan
                                <li class="nav-item"> <a class="nav-link" href="{{ route('adminView') }}"> Data Admin </a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{ route('viewAktivitas') }}"> Aktivitas Admin
                                    </a></li>
                            </ul>
                        </div>
                    </li>
    ...
    <!-- Data Table-->
    <script type="text/javascript" src="{{ asset('assets3/datatables.min.js') }}"></script>
    <script>
        $('#myTable').DataTable({
            responsive: true
        });
