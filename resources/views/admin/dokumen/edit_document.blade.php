...
@section('content')
  ...
  <div class="row">
    <div class="container mt-5 border border-2 shadow-sm rounded" style="width: 50rem">
      ...
      @endif
      <form action="{{ route('admin.prosesUbahDokumen', $document->id) }}" method="POST" enctype="multipart/form-data" class="m-4">
        @csrf
        <div class="mb-3">
          <label for="judul" class="form-label">judul</label>
          <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" id="judul" value="{{ $document->judul }}">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text"  class="form-control @error('nomor') is-invalid @enderror" id="nomor" name="nomor" value="{{ $document->nomor }}">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control @error('judul') is-invalid @enderror" id="tanggal_pengesahan" name="tanggal_pengesahan" value="{{ $document->tanggal_pengesahan }}">
        </div>
